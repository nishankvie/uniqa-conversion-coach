"""
Persona data-gen harness — the A1 probe (deferred/PERSONA_MODEL_PLAN.md §7 step 1).
...
from calculator.funnel import Step, STEP_ORDER, PERSONA_WEIGHTS, ABANDON_PROBS
from calculator.contracts import Event, EventType, ActivityLog, new_session_id
from persona.personas import PERSONA_BRIEFINGS
from calculator.journey import STEP_SCREENS, render_step
from calculator.play import ascii_screen
from persona.psyche import init_mind, step_dynamics, evaluate_bounce
from calculator.widget import (render_action_space, legal_events, STEP_ACTIONS,
                          widget_response_model, ux_complexity, TARIFFS, tariff_coverage_brief,
                          HEALTH_SURCHARGE_RANGE)
from calculator.scope import premium as _premium, Tariff as _Tariff
...
_PROMPT_DIR = Path(__file__).resolve().parents[1] / "prompts" / "personas"
...
# This is an early DETECTION signal the coach sees before any click. See docs/COACH_MODEL.md (§3).
_TRAFFIC_W = {
