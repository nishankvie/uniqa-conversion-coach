...
STEP_SCREENS: dict[Step, dict] = {
    ...
    Step.TARIFF_SELECT: {
        ...
        "tariffs": [
            {"name": "Start",   "price": "38,74", "online": True},
            {"name": "Optimal", "price": "68,14", "online": True},
            {"name": "Opt.Plus","price": "96,66", "online": False},
            {"name": "Premium", "price": "140,15","online": False},
        ],
...
def _confidence(action: CoachAction, mind: Mind, step: Step) -> float:
    ...
    from coach.coach import get_modifier
