...
generalize. Plugs the intervention catalog (interventions.py) + signals (docs/COACH_MODEL.md §3)
+ per-screen design (docs/COACH_MODEL.md §6) into one prompt.
...
from coach.interventions import CATALOG
...
## Hypotheses you reason with (priors to TEST, not rules) — see docs/COACH_MODEL.md §5 (H1…)
