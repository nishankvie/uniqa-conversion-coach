...
from uniqa.funnel import Step, STEP_ORDER, generate_signals
from uniqa.contracts import Event, EventType, ActivityLog, CoachObservation, CoachDecision, new_session_id
from uniqa.coach_io import activity_from_signals, observation_from_log
from uniqa.psyche import init_mind, step_dynamics, evaluate_bounce, apply_coach_effect
from uniqa.widget import legal_events, tariff_by_id
from uniqa.coach import MESSAGE_BUDGET
...
class LLMPersona:
    ...
    def __init__(self, model: str | None = None):
        from uniqa.persona_datagen import LLMTeacher, parse_session
