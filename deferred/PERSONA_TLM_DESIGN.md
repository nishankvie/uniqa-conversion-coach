...
Folds into `docs/PERSONA_MODEL_PLAN.md`. Grounded in `calculator/contracts.py`,
`calculator/tlm.py`, `persona/psyche.py`, `calculator/eventproc.py`,
...
The Z3 gate in `deferred/coach_autoimprove_z3.py` requires `τ ≥ 2b`; the budget
