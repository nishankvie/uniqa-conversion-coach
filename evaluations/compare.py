...
Compare a captured HUMAN session against PERSONA-BOT generated sessions.
    ...
    python -m evaluations.compare _local/captures/<file>.json            # vs bot (offline teacher)
    python -m evaluations.compare _local/captures/<file>.json --persona franz --n 20
...
from calculator.contracts import ActivityLog, EventType
from calculator.capture import load_log
...
def bot_logs(persona: str, n: int, seed: int = 0):
    import random
    from persona.persona_datagen import generate_feed, OfflineTeacher
